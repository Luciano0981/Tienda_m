...
public class ReporteServiceImpl implements ReporteService {
    ...
    public ResponseEntity<Resource> generaReporte(String reporte,
        ...
        try {
            //se asigna el tipo de pajina a generar
            ...
            // A partir de aca inicia la respuesta al usurario   
            ...
            switch (tipo) {
                ...
                case "Pdf", "vPdf" -> { //Segenera un reporte en PDF
                    JasperExportManager
            ...
            //A partir de aca se raliza la respuesta al usuario 
            byte[]data=salida.toByteArray();
            HttpHeaders headers = new HttpHeaders();
            headers.set("Content-Disposition",estilo+"filenmae=\""+archivoSalida+"\"");
